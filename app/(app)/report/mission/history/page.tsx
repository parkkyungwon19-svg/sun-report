...
export default async function MissionReportHistoryPage() {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-xl font-bold text-primary">지난 선교회보고서</h2>
                  ...
                  >
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">
                        {r.total_sun}순 참석 · {r.total_attend}명 ·{" "}
                        {r.total_offering.toLocaleString()}원
                      </p>
                    </div>
